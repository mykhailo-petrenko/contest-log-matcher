...
from . import QSO, Cabrillo

from .errors import InvalidQSOException, InvalidLogException
from .data import KEYWORD_MAP
...
def parse_log_text(text, ignore_unknown_key=False, check_categories=True, ignore_order=False):
    ...
    Attributes in .data.KEYWORD_MAP will be parsed accordingly. X-
