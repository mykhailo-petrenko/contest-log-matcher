...
def test_parse_grid_locator():
    ...
    long8 = ("BL11BH16", "START-OF-LOG: 3.0\nGRID-LOCATOR: BL11BH16")
    long10 = ("BL11BH16OO", "START-OF-LOG: 3.0\nGRID-LOCATOR: BL11BH16OO")

    for grid, text in [empty, short, long, spaces, long8, long10]:
